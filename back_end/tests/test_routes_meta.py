...
# ==============================================================================
def test_criar_meta_sucesso(client, auth_headers):
    ...
    with patch("services.meta_service.MetaService.criar_meta") as mock_service:
        ...
        response = client.post("/api/metas/", json=payload, headers=auth_headers)
...
def test_criar_meta_erro_pydantic_validacao(client, auth_headers):
...
def test_criar_meta_erro_regra_de_negocio_service(client, auth_headers):
...
def test_criar_meta_payload_vazio(client, auth_headers):
...
# ==============================================================================
def test_obter_meta_ativa_sucesso(client, auth_headers):
    ...
    with patch("services.meta_service.MetaService.obter_meta_ativa") as mock_service:
        ...
        response = client.get("/api/metas/ativa", headers=auth_headers)
...
def test_obter_meta_ativa_nao_encontrada(client, auth_headers):
...
# ==============================================================================
def test_atualizar_meta_sucesso(client, auth_headers):
    ...
    with patch("services.meta_service.MetaService.atualizar_meta") as mock_service:
        ...
        response = client.put("/api/metas/3", json=payload, headers=auth_headers)
...
def test_atualizar_meta_erro_pydantic_validacao(client, auth_headers):
...
def test_atualizar_meta_nao_encontrada(client, auth_headers):
    ...
    with patch("services.meta_service.MetaService.atualizar_meta") as mock_service:
        ...
        response = client.put("/api/metas/999", json=payload, headers=auth_headers)
...
# ==============================================================================
def test_deletar_meta_sucesso(client, auth_headers):
    ...
    with patch("services.meta_service.MetaService.deletar_meta") as mock_service:
        ...
        response = client.delete("/api/metas/2", headers=auth_headers)
...
def test_deletar_meta_nao_encontrada_404(client, auth_headers):
    """Garante HTTP 400 caso ocorra erro ao deletar a meta."""
    with patch("services.meta_service.MetaService.deletar_meta") as mock_service:
        mock_service.return_value = (False, "Meta não encontrada.")

        response = client.delete("/api/metas/999", headers=auth_headers)
...
def test_deletar_meta_ativa_regra_negocio_400(client, auth_headers):
    ...
    with patch("services.meta_service.MetaService.deletar_meta") as mock_service:
        ...
        response = client.delete("/api/metas/1", headers=auth_headers)
...
# ==============================================================================
def test_cancelar_meta_sucesso(client, auth_headers):
    ...
    with patch("services.meta_service.MetaService.cancelar_meta") as mock_service:
        ...
        response = client.put("/api/metas/cancelar/10", headers=auth_headers)
...
def test_cancelar_meta_erro_regra_negocio(client, auth_headers):
    ...
    with patch("services.meta_service.MetaService.cancelar_meta") as mock_service:
        ...
        response = client.put("/api/metas/cancelar/999", headers=auth_headers)
...
# ==============================================================================
def test_listar_metas_concluidas_sucesso(client, auth_headers):
    ...
    with patch("services.meta_service.MetaService.obter_metas_concluidas") as mock_service:
        ...
        response = client.get("/api/metas/concluidas", headers=auth_headers)
...
def test_listar_metas_concluidas_erro_servico(client, auth_headers):
...
# ==============================================================================
def test_concluir_meta_sucesso(client, auth_headers):
    ...
    with patch("services.meta_service.MetaService.concluir_meta") as mock_service:
        ...
        response = client.put("/api/metas/concluir/10", headers=auth_headers)
...
def test_concluir_meta_erro_regra_negocio(client, auth_headers):
